...
def create_addon(files, browser):
	...
	output_file = os.path.join(output_folder, f'lc2redirector-{browser}.{ext}')
...
def create_zip(files):
	...
	output_file = os.path.join(output_folder, f'lc2-{browser}.{ext}')
	zf = zipfile.ZipFile(output_file, 'w', zipfile.ZIP_STORED)
	cert = 'extension-certificate.pem'
...
if __name__ == '__main__':
	...
	create_zip(files, 'lc2navigator2025')
