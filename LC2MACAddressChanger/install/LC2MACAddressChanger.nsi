...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "LC2MACAddressChanger"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "LC2MACAddressChanger Client"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "LC2MACAddressChanger"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.0.0"

;--------------------------------


Name "LC2MACAddressChanger"
Caption "LC2MACAddressChanger Install (c)by http://www.letztechance.org"
Icon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"
OutFile "LC2MACAddressChangerinstall.exe"
...
InstallDir "$PROGRAMFILES\LETZTECHANCE.ORG\LC2MACAddressChanger"
InstallDirRegKey HKLM "Software\LETZTECHANCE.ORG\LC2MACAddressChanger" "LC2MACAddressChanger"
...
;	CreateShortCut "$SMPROGRAMS\$R0\All users LC2MACAddressChanger.lnk" $INSTDIR\LC2MACAddressChanger.exe
;Abort
;!else
...
;MessageBox MB_YESNO "Wollen Sie dieses Programm wirklich installieren ?" IDYES
  ...
  WriteRegStr HKLM SOFTWARE\WWW.LETZTECHANCE.ORG\LC2MACAddressChanger "Install_Dir" "$INSTDIR"

  ; write uninstall strings
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MACAddressChanger" "DisplayName" "LC2MACAddressChanger (remove only)"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MACAddressChanger" "UninstallString" '"$INSTDIR\uninst.exe"'
;---Extrahiere Dateien --------------------->
  SetOutPath $INSTDIR
  ;File /a "exe\LC2MACAddressChanger.exe"
  ;File /a "exe\*.*"
  File /a ".\install.zip"
...
SectionIn 1 4 3
  ...
  WriteRegStr HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MACAddressChanger "StrTest_INSTDIR" "$INSTDIR"
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MACAddressChanger "DwordTest_0xDEADBEEF" 0xdeadbeef
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MACAddressChanger "DwordTest_123456" 123456
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MACAddressChanger "DwordTest_0123" 0123
  WriteRegBin HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MACAddressChanger "BinTest_deadbeef01f00dbeef" "DEADBEEF01F00DBEEF"
;  StrCpy $8 "$SYSDIR\LC"
...
Section "CreateShortCuts"
 ...
 CreateDirectory $SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\Start.LC2Launcher.lnk" $INSTDIR\LC2MACAddressChanger.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\LC2MACAddressChanger.lnk" $INSTDIR\LC2MACAddressChanger.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\_LC2Launcher.lnk" $INSTDIR\LC2MACAddressChanger.exe
 CreateShortCut "$INSTDIR\Update.lnk" $INSTDIR\LC2Start.NET.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\AutoStart.lnk" $INSTDIR\LC2autostart.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\AutoStartConfig.lnk" $INSTDIR\LC2autostartConfig.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\AutoStartUninstall.lnk" $INSTDIR\LC2autostartUninstall.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\LC2Config.lnk" $INSTDIR\LC2Config.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\Uninstall.lnk" $INSTDIR\uninst.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\Support.lnk" $INSTDIR\letztechance.org.url
  SectionIn 1 2 3
...
UninstallText "Uninstall LC2MACAddressChanger ?"
;UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\nsis1-uninstall.ico"
UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"

Section "Uninstall"

  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MACAddressChanger"
  DeleteRegKey HKLM "SOFTWARE\WWW.LETZTECHANCE.ORG\LC2MACAddressChanger"

;  Delete "$SMPROGRAMS\WWW.LETZTECHANCE.ORG\LC2MACAddressChanger\reg\*.*"
...
;  File /a "exe\lc2sys.dll"
  ...
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\LC2MACAddressChanger.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\uninst.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MACAddressChanger\*.*"
