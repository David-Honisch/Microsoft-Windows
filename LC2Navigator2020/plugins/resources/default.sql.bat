...
echo INSERT OR REPLACE INTO application(person_id, name, first_name, description, zipcode, city, street, url)VALUES(100,'%in% v.1.01a','%in% v.1.01a','','','','','exec .\\resources\\plugins\\%in%\\%in%.bat .\\resources\\plugins\\%in%\\menu.csv'); >> %out%
