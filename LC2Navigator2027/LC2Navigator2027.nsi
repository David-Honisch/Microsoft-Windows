...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "LC2Navigator2027"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "LC2Navigator2027 Client x64"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "LC2Navigator2027 x64"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.0.0"

;--------------------------------


Name "LC2Navigator2027"
Caption "LC2Navigator2027 Install (c)by http://www.letztechance.org"
Icon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"
OutFile "LC2Navigator2027install.exe"
...
InstallDir "$PROGRAMFILES\LETZTECHANCE.ORG\LC2Navigator2027"
InstallDirRegKey HKLM "Software\LETZTECHANCE.ORG\LC2Navigator2027" "LC2Navigator2027"
...
;	CreateShortCut "$SMPROGRAMS\$R0\All users LC2Navigator2027.lnk" $INSTDIR\LC2Navigator2027.exe
;Abort
;!else
...
;MessageBox MB_YESNO "Wollen Sie dieses Programm wirklich installieren ?" IDYES
  ...
  WriteRegStr HKLM SOFTWARE\WWW.LETZTECHANCE.ORG\LC2Navigator2027 "Install_Dir" "$INSTDIR"

  ; write uninstall strings
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2027" "DisplayName" "LC2Navigator2027 (remove only)"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2027" "UninstallString" '"$INSTDIR\uninst.exe"'
;---Extrahiere Dateien --------------------->
  SetOutPath $INSTDIR
  ;File /a "exe\LC2Navigator2027.exe"
  ;File /a "exe\*.*"
  File /a ".\install.zip"
...
SectionIn 1 4 3
  ...
  WriteRegStr HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2027 "StrTest_INSTDIR" "$INSTDIR"
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2027 "DwordTest_0xDEADBEEF" 0xdeadbeef
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2027 "DwordTest_123456" 123456
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2027 "DwordTest_0123" 0123
  WriteRegBin HKLM SOFTWARE\LETZTECHANCE.ORG\LC2Navigator2027 "BinTest_deadbeef01f00dbeef" "DEADBEEF01F00DBEEF"
;  StrCpy $8 "$SYSDIR\LC"
...
Section "CreateShortCuts"
 ...
 CreateDirectory $SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\LC2Navigator2027.start.exe.lnk" $INSTDIR\LC2Navigator2027.start.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\LC2Navigator2027.lnk" $INSTDIR\LC2Navigator2027.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\LC2Launcher.lnk" $INSTDIR\LC2Navigator2027.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\_LC2Launcher.lnk" $INSTDIR\LC2Navigator2027.exe
 

 CreateShortCut "$INSTDIR\Update.lnk" $INSTDIR\LC2Navigator2027.start.exe
 CreateShortCut "$INSTDIR\LC2Navigator2027.start.exe.lnk" $INSTDIR\LC2Navigator2027.start.exe
 CreateShortCut "$INSTDIR\LC2Navigator2027.exe.lnk" $INSTDIR\LC2Navigator2027.exe
 CreateShortCut "$DESKTOP\LC2Navigator2027.exe.lnk" $INSTDIR\LC2Navigator2027.exe

 CreateShortCut "$DESKTOP\LC2Navigator2020.exe.lnk" $INSTDIR\LC2Navigator2027.start.exe

 

 
; CreateShortCut "$SMPROGRAMS\Startup\LC2Navigator2027.exe.lnk" "$INSTDIR\LC2Navigator2027-win32-ia32\LC2Navigator2027.exe"
 
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\AutoStart.lnk" $INSTDIR\LC2autostart.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\AutoStartConfig.lnk" $INSTDIR\LC2autostartConfig.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\AutoStartUninstall.lnk" $INSTDIR\LC2autostartUninstall.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\LC2Config.lnk" $INSTDIR\LC2Config.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\Uninstall.lnk" $INSTDIR\LC2Navigator2027_uninst.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\Support.lnk" $INSTDIR\letztechance.org.url
  SectionIn 1 2 3
...
CreateShortCut "$SMPROGRAMS\Startup\LC2Navigator2027.exe.lnk" $INSTDIR\LC2Navigator2027.exe
SectionEnd
...
Section "Programm und Hilfe ausführen..." TESTIDX
  ...
  SearchPath $1 $INSTDIR\LC2Navigator2027.start.exe
...
UninstallText "Uninstall LC2Navigator2027 ?"
;UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\nsis1-uninstall.ico"
UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"

Section "Uninstall"

  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2Navigator2027"
  DeleteRegKey HKLM "SOFTWARE\WWW.LETZTECHANCE.ORG\LC2Navigator2027"

;  Delete "$SMPROGRAMS\WWW.LETZTECHANCE.ORG\LC2Navigator2027\reg\*.*"
...
;  File /a "exe\lc2sys.dll"
  ...
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\LC2Navigator2027.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\uninst.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2Navigator2027\*.*"
