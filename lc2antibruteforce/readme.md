# LC2 High Security AntiBruteForce Server v2.0 by David Honisch

lc2antibruteforce.exe 
- Is High Security Anti-Brute Force Protection System
- developed in rust
...
<a href="lc2antibruteforce.exe">lc2antibruteforce.exe</a>
